...
public class FitMindAdapter extends RecyclerView.Adapter<FitMindAdapter.ViewHolder> {

    private Context context;
    private List<ProgramsModel> list;

    public FitMindAdapter(Context context, List<ProgramsModel> list) {
    ...
    @NonNull
    @Override
    public FitMindAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(context)
                .inflate(R.layout.fit_body_items_list, parent, false);

        return new FitMindAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final FitMindAdapter.ViewHolder holder, int position) {
    ...
    private void setFitMindProgramsData(final FitMindAdapter.ViewHolder holder, ProgramsModel model) {
